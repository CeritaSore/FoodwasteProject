        ...
        {isLoading ? (
          ...
          inventory.map((item) => (
            <div
              ...
              className="bg-white rounded-2xl shadow-sm border border-gray-200/80 p-4 flex items-center gap-4 cursor-pointer transition-all duration-300 hover:shadow-lg hover:scale-[1.02]"
            >
              ...
              <div className="flex-grow">
                ...
                <div className="flex flex-col text-xs text-gray-500 mt-2 space-y-1">
                  <span className="flex items-center gap-1.5">
                    <Icon name="box" className="h-3.5 w-3.5" /> Disimpan di:{" "}
                    {item.store_at}
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Icon name="calendar" className="h-3.5 w-3.5" /> Expire
                    pada: {item.expired_at}
                  </span>
                </div>
              </div>
